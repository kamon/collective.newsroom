...
starting from your buildout directory::
    ...
    cd src/collective.newsroom/src
    ../../../bin/paster add --list
...
collective, and inside that, the package heart: newsroom.

Inside src/collective/newsroom:
...
run all your package tests with the command::
    ...
    bin/test -s collective.newsroom
